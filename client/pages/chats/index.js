  ...
  return (
    <UserContext.Provider value={{ user, setUser }}>
      <div className="w-[100%] bg-blue-400">
        <SideDrawer user={user} UserContext={UserContext} AuthContext={AuthContext} />
        <Box className="flex justify-between w-[100%] h-[91.5vh] p-[10px]">
          <MyChats UserContext={UserContext} AuthContext={AuthContext} fetchAgain={fetchAgain} setFetchAgain={setFetchAgain} />
          <ChatBox UserContext={UserContext} AuthContext={AuthContext} fetchAgain={fetchAgain} setFetchAgain={setFetchAgain}  />
        </Box>
      </div>
